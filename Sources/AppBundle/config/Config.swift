...
struct Config: ConvenienceMutable {
    ...
    var windowInsertionPolicy: WindowInsertionPolicy = .default
    var bspFloatAfterSplits: Int = 0
    ...
    // Workspace preview (HUD) configuration
    // nil = disabled, non-nil = the modifier combo that triggers the HUD
...
enum WindowInsertionPolicy: String {
    case `default`
    case bsp
}
